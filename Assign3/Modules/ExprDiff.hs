...
{- Test cases 
	- for simplify with empty vrs
 
---------------------------------------------------------------------------------------------------------------
- for addition:
	- var "x" !+ val 0 == var "x"

	- var "x" !+ val 0 !+ var "y" == (var "x") + (var "y")

	- var "y" !+ val 0 !+ var "x" == (var "x") + (var "y")

    - var "x"  !+ val 1 !+ var "y" !+ val 2 == (val 3) + ((var "x") + (var "y"))

    - val 2 !+ val 3 !+ val 3 == val 8

    - val 2 !+ val 3 !+ val 3 !+ var "x" == (val 8) + (var "x")

    - val 1 !+ var "x" !+ val 2 = (val 3) + (var "x")

	- var "x"  !+ val 1 !+ var "y" !+ val 2 == (val 3) + ((var "x") + (var "y"))

	- var "x"  !+ val 1 !+ var "y" !+ val 2 !+ var "z" !+ val 1 == (val 4) + (((var "x") + (var "y")) + (var "z"))

	- var "y" !+ var "x" == (var "x") + (var "y")

	- var "x" !+ var "x" == (val 2) * (var "x")

	- var "x"  !+ val 1 !+ var "x" !+ val 2 == (val 3) + ((val 2) * (var "x"))

	-  var "y"  !+ val 1 !+ var "x" !+ val 2 == (val 3) + ((var "x") + (var "y"))
...
----------------------------------------------------------------------------------------------------------------
 - for multiplication:
 	...
 	- var "x" !* val 2 == (val 2) * (var "x")

 	- val 2 !* val 3 !* var "x" == (val 6) * (var "x")

 	- val 2 !* var "x" !* val 3 == (val 6) * (var "x")

 	


----------------------------------------------------------------------------------------------------------------
 - for combination of add and mult:

 	- var "y" !* val 2 !+ val 3 == (val 3) + ((val 2) * (var "y"))

 	- var "y" !* val 2 !+ val 3 !+ val 1 == (val 4) + ((val 2) * (var "y"))

 	- var "x"  !+ val 1 !+ (val 2 !* var "y") !+ val 2 !+ var "z" !+ val 1  == (val 4) + (((var "x") + ((val 2) * (var "y"))) + (var "z"))

	- val 2 !* (val 2 !+ val 3) == val 10

 	- val 2 !* (var "x" !+ var "y") == ((val 2) * (var "x")) + ((val 2) * (var "y"))

 	- val 2 !* (var "y" !+ var "x") == ((val 2) * (var "x")) + ((val 2) * (var "y"))

	- val 1 !* var "x" !+ (val 2 !* var "x") == (val 3) * (var "x")

	- var "x" !* val 2 !+ var "x" == (val 3) * (var "x")

	- var "y" !* val 2 !+ var "x" == (var "x") + ((val 2) * (var "y"))

	- var "x" !* val 2 !+ (var "x" !* val 2) == (val 4) * (var "x")

	- var "x" !* val 2 !+ (var "x" !* val 2) !+ val 1 = (val 1) + ((val 4) * (var "x")) 

	- var "x" !+ val 1 !+ var "x" == (val 1) + ((val 2) * (var "x"))

-------------------------------------------------------------------------------------------------
- for Exp:
	- (var "x" !^ 3) !* (var "x" !^ 2) == (var "x") ^ 5

	- (var "x" !^ 2) !+ (var "x" !^ 2) == (val 2) * ((var "x") ^ 2)
...
{-Test cases:
	- for simplify with non-empty vrs:
	-----------------------------------------------------------------------------------
		- simplify (Map.fromList [("x",2)]) $ (val 2 !+ var "x") !+ (val 4 !+ var "y") == (val 8) + (var "y")
	
	- for eval:
	-------------------------------------------------------------------------------------
		- eval (Map.fromList [("x",2)]) $ loga 2 (val 12) == 4
...
{- Test cases:
    - for partDiff:
    ---------------------------------------------------------------------------------
    	- partDiff "x" (var "x" !* var "x") == (val 2) * (var "x")

    	- partDiff "y" (var "x" !* var "x") == var 0

    	- partDiff "x" (var "x" !* var "x" !+ (val 3 !* var "x") !+ val 2) == (val 3) + ((val 2) * (var "x"))

    	- partDiff "x" (var "x" !+ (var "x" !* var "x") !+ (val 3 !* var "x")) == (val 4) + ((val 2) * (var "x"))

    	- partDiff "x" (var "x" !* var "y") == var "y"

    	- partDiff "y" (var "x" !* var "y") ==  var "x"

    	- partDiff "x" (var "x" !* var "x" !* var "y" !+  var "x") == (val 1) + (((val 2) * (var "x")) * (var "y"))

    	- partDiff "y" (var "x" !* var "x" !* var "y" !+  var "x") == (var "x") * (var "x")

    	- partDiff "x" $ ln (var "x") == (var "x") ^ -1

    	- partDiff "x" $ ln (val 10) == val 0

    	- partDiff "x" $ loga 2 (var "x") = (var "x") ^ -1

    	- partDiff "x" $ (val 2) !* (var "x" !^ 3) == (val 6) * ((var "x") ^ 2)
